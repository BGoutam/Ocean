...
#Divide the dataset into training and testing data
    ...
    loaded_model = RandomForestClassifier(n_estimators = 500, max_depth = 4, max_features = 3, bootstrap = True, random_state = 18).fit(X_train, Y_train)
    ...
    with open(filename,"w") as stats_file:
        ...
        stats_file.write('\n')
    pkl = "RF_Model.pkl" if local else "data/outputs/RFModel"
    with open(pkl, "wb") as pickle_file:
        print(f"Pickling results in {pkl}")
